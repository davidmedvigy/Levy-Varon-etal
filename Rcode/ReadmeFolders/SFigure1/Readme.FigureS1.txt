SFigure1.R contains the R code used to create supplemental figure 1. Figure 1 shows results from the Individual level fixation and the ecosystem level fixation simulations.  
