...
subroutine load_ed_ecosystem_params()
   ...
   !   30 | Facultative_Fixer                          |      no |      yes |           no !
   !   31 | Obligate_Fixer                             |      no |      yes |           no !
   !------+--------------------------------------------+---------+----------+--------------!
   ...
   pft_name16(18) = 'Early Trop LD   '
   pft_name16(19) = 'Mid Trop LD     '
   pft_name16(20) = 'Late Trop LD    '
   pft_name16(21) = 'ANNA            '
   pft_name16(22) = 'ANNA            '
   pft_name16(23) = 'ANNA            '
   pft_name16(24) = 'XXX             '
   pft_name16(25) = 'XXX             '
   pft_name16(26) = 'Xiangtao        '
   pft_name16(27) = 'Xiangtao        '
   pft_name16(28) = 'Xiangtao         '
   pft_name16(29) = 'XXX  '
   pft_name16(30) = 'Facultative_Fixer   '
   pft_name16(31) = 'Obligate_Fixer   '
   pft_name16(32) = 'XXX      '
   pft_name16(33) = 'XXX         '
   pft_name16(34) = 'XXX      '
   pft_name16(35) = 'XXX         '
...
subroutine init_can_rad_params()
   ...
   leaf_reflect_vis(18:20)   = 1.3d-1 ! 6.2d-2
   leaf_reflect_vis(21:35) = 1.3d-1  !JL!
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   leaf_reflect_nir(18:20)   = 6.30d-1
   leaf_reflect_nir(21:35)   = 6.30d-1 !JL
   !---------------------------------------------------------------------------------------!
   ...
   wood_reflect_vis(18:20)   = 1.60d-1
   wood_reflect_vis(21:35)   = 1.60d-1 !JL
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   wood_reflect_nir(18:20)   = 3.90d-1
   wood_reflect_nir(21:35)   = 3.90d-1!JL
   !---------------------------------------------------------------------------------------!
   ...
   leaf_trans_vis(  18:20) = 2.80d-2  ! 5.00d-2
   leaf_trans_vis(  21:35) = 2.80d-2  ! 5.00d-2   !JL
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   leaf_trans_nir(  18:20) = 2.48d-1
   leaf_trans_nir(  21:35) = 2.48d-1 !JL
   !---------------------------------------------------------------------------------------!
   ...
   wood_trans_vis(  18:20) = 1.00d-3
   wood_trans_vis(  21:35) = 1.00d-3!JL
   !----- Near infrared. ------------------------------------------------------------------!
   ...
   wood_trans_nir(  18:20) = 1.00d-3
   wood_trans_nir(  21:35) = 1.00d-3 !JL
   !---------------------------------------------------------------------------------------!
   ...
   !---------------------------------------------------------------------------------------!
   !----- Visible (PAR). ------------------------------------------------------------------!
   leaf_scatter_vis(1:35) = leaf_reflect_vis(1:35) + leaf_trans_vis(1:35) !JL!
   wood_scatter_vis(1:35) = wood_reflect_vis(1:35) + wood_trans_vis(1:35)!JL!
   !----- Near infrared. ------------------------------------------------------------------!
   leaf_scatter_nir(1:35) = leaf_reflect_nir(1:35) + leaf_trans_nir(1:35) !JL
   wood_scatter_nir(1:35) = wood_reflect_nir(1:35) + wood_trans_nir(1:35) !JL
   !---------------------------------------------------------------------------------------!
   ...
   !---------------------------------------------------------------------------------------!
   !----- Visible (PAR). ------------------------------------------------------------------!
   leaf_backscatter_vis(1:35) = (2.d0 * leaf_reflect_vis(1:35) - leaf_trans_vis(1:35))     &
                              / (3.d0 * leaf_scatter_vis(1:35))
   wood_backscatter_vis(1:35) = (2.d0 * wood_reflect_vis(1:35) - wood_trans_vis(1:35))     &
                              / (3.d0 * wood_scatter_vis(1:35))
   !----- Near infrared. ------------------------------------------------------------------!
   leaf_backscatter_nir(1:35) = (2.d0 * leaf_reflect_nir(1:35) - leaf_trans_nir(1:35))     &
                              / (3.d0 * leaf_scatter_nir(1:35))
   wood_backscatter_nir(1:35) = (2.d0 * wood_reflect_nir(1:35) - wood_trans_nir(1:35))     &
                              / (3.d0 * wood_scatter_nir(1:35))
   !---------------------------------------------------------------------------------------!
   ...
   leaf_emis(18:20)   = 9.50d-1
   leaf_emis(21:35)   = 9.50d-1 !JL
   ...
   wood_emis(18:20)   = 9.00d-1
   wood_emis(21:35)   = 9.00d-1 !JL
...
subroutine init_pft_photo_params()
   ...
   Vm_low_temp(18:20)            =  8.0             ! late tropical
   Vm_low_temp(21:35)            =  8.0     !JL!       
   ...
   Vm_high_temp(18:20)           =  45.0  + thioff ! C3
   Vm_high_temp(21:35)           =  45.0  + thioff ! C3
   ...
   Vm0(18)                    = 18.750 ! 18.750 * vmfact
   Vm0(19)                    = 12.500  ! 12.500 * vmfact
   Vm0(20)                    =  6.250 !  6.250 * vmfact
   Vm0(21:35)                 = 27 *1.2 !18.750  ! 12.500 * vmfact JL
   !---------------------------------------------------------------------------------------!
   ...
   dark_respiration_factor(2)     = 0.02  ! JL0.02   !0.02 !0.015 ! 0.020 * gamfact
   ...
   dark_respiration_factor(21:35)     = 0.02 !0.015 ! 0.020 * gamfact !JL!
   !---------------------------------------------------------------------------------------!
   ...
   stomatal_slope(1)         =  4.0 !5.0
   stomatal_slope(2)         =  10.0! 9.0 ! 8.0    * mfact
   stomatal_slope(3)         =  10.0 ! 9.0 ! 8.0    * mfact
   stomatal_slope(4)         =  10.0 !9.0 ! 8.0    * mfact
   ...
   stomatal_slope(18:20)         =  10.0! 9.0 ! 8.0    * mfact
   stomatal_slope(21:35)         =  10.0 ! 9.0 ! 8.0    * mfact
   ...
   cuticular_cond(18:20)         = 10000.0
   cuticular_cond(21:35)         = 10000.0!JL!
   ...
   quantum_efficiency(18:20)     = 0.070 ! 0.08  * alphafact
   quantum_efficiency(21:35)     = 0.070 ! 0.08  * alphafact!JL
   ...
   !---------------------------------------------------------------------------------------!
   water_conductance(1:35) = 450. / yr_sec ! 150. / yr_sec * kfact
   !---------------------------------------------------------------------------------------!
   ...
   photosyn_pathway(18:20)     = 3
   photosyn_pathway(21:35)     = 3 !JL
   ...
   leaf_width(16)    = 0.20
   leaf_width(17)    = 0.05
   leaf_width(18:20)    = 0.20
   leaf_width(21:35)    = 0.20 !JL
   !---------------------------------------------------------------------------------------!
...
!   resp_temperature_increase = 0.0757
   ...
   resp_opt_water            = 0.95
   resp_water_below_opt      = 2.2
   resp_water_above_opt      = 2.2
   resp_temperature_increase = 0.092

   N_immobil_supply_scale    = 40.0 / yr_day
   cwd_frac                  = 0.2
   r_fsc                     = 1.0
   ! r_stsc                    = 0.3
   r_stsc                    = 1 !JL all decomposition of structural pool goes to respiration, sets input to soil pooolto 0
 r_ssc                     = 1.0
   K1                        = 4.5   / yr_day
   K2                        = 11.0  / yr_day
  ! K3                        = 100.2 / yr_day
   K3                        = 0  ! JL making decay rate of slow soil pool 0, will make slow C loss 0
  FSN_ndays_to_avg = 2 !JL this is (N+1) for the days you want to average so setting it to 4 will average the 3 previous days
   return
...
subroutine init_pft_resp_params()
   ...
   growth_resp_factor(21:35)          = onethird !JL
!!!!!!!!!!!!JL!!!!!!!!!!!!!!!!!!!!!!
  ...
  ! leaf_turnover_rate(1)          = 0.0001 !JL
  ! leaf_turnover_rate(2)          = 0.0001 !JL
  ! leaf_turnover_rate(3)          = 0.0001 !JL
  ! leaf_turnover_rate(4)          = 0.0001 !JL
   !leaf_turnover_rate(5)          = 0.0001 !!JL
...
!!!!!!!!!!!!JL!!!!!!!!!!!!!!!!!!!!!!
   ...
   leaf_turnover_rate(19)          = 0.5
   leaf_turnover_rate(20)          = onethird
   leaf_turnover_rate(21:35)          =  1.0 !JL
   !----- Root turnover rate.  ------------------------------------------------------------!
...
!!!!!!!!!!!!JL!!!!!!!!!!!!!!!!!!!!!!
   ...
   !root_turnover_rate(2)          = 1      !6.6 JL,( roots turned over every 2 months, now they turn over 1x yr)
   !root_turnover_rate(3)          = 1     !6.6 JL
  ! root_turnover_rate(4)          = 1     !6.6 JL


  ! root_turnover_rate(1)          = 0.3 !0 JL
   !root_turnover_rate(2)          = 0.3      !6.6 JL,( roots turned over every 2 months, now they turn over 1x yr)
   !root_turnover_rate(3)          = 0.3     !6.6 JL
   !root_turnover_rate(4)          = 0.3    !6.6 JL
!!!!!!!!!!!!JL!!!!!!!!!!!!!!!!!!!!!!
   ...
   root_turnover_rate(18)          = 1.0
   root_turnover_rate(19)          = 0.5
   root_turnover_rate(20)          = onethird
   root_turnover_rate(21:35)          = 1 ! 0.3 !6.6  !JL!
   ...
   storage_turnover_rate(21:35)       = 0.00 ! 0.25 !JL

   root_respiration_factor(1:35)  = 0.528 !JL
...
subroutine init_pft_mort_params()
   ...
   frost_mort(18:20)   = 3.0
   frost_mort(21:35)   = 3.0 !JL
...
!   mort1(4)  = 10.0
   ...
   mort1(2)  = 0.03 !10 !0.03
   mort1(3)  = 0.03 !10!0.03
   mort1(4)  = 0.03 !10!0.03
   ...
   mort3(2)  = 0.15 * (1. - rho(2)) *0.9 !JL multiplied by 0.9
   mort3(3)  = 0.15 * (1. - rho(3)) *0.9 !JL multiplied by 0.9
   mort3(4)  = 0.15 * (1. - rho(4)) *0.9 !JL multiplied by 0.9
...
!   mort3(4)  = 0.0
   ...
   mort3(18)  = 0.15 * (1. - rho(18) / rho(20))  
   mort3(19)  = 0.15 * (1. - rho(19) / rho(20))
   mort3(20)  = 0.0
   mort3(21:35)  =  0.15 * (1. - rho(30)) *1.1  !JL 
   ...
   seedling_mortality(2:4)  = 0.95 ! JL changed from 0.95 to 1
!   seedling_mortality(2)  = 0.5
!   seedling_mortality(3)  = 0.95
!   seedling_mortality(4)  = 0.97
   ...
   seedling_mortality(21:35)  = 0.95! !.95 !JL 
!seedling_mortality=0.
   treefall_s_gtht(1:35)    = 0.0

   treefall_s_ltht(1)       = 0.25 !JL, 0 for !
   treefall_s_ltht(2:4)     =  0.10 !JL,0 for!
!   treefall_s_ltht(2)     = 0.25
!   treefall_s_ltht(3)     = 0.10
!   treefall_s_ltht(4)     = 0.10
!   treefall_s_ltht(2:4)     = 0.02
   treefall_s_ltht(5)       = 0.25
   treefall_s_ltht(6:11)    = 0.10
   treefall_s_ltht(12:15)   = 0.25
   treefall_s_ltht(16)      = 0.25
   treefall_s_ltht(17)      = 0.10
   treefall_s_ltht(18:20)     = 0.10
   treefall_s_ltht(21:35)     =  0.10 !JL,0 for!
...
!!!!!treefall_s_ltht(:) = 0.0
   ...
   plant_min_temp(18:20)      = t00+2.5
   plant_min_temp(21:35)      = t00+2.5 !JL
   return
...
subroutine init_pft_alloc_params()
   ...
   is_tropical(16)    = .true.
   is_tropical(18:20)   = .true.
   is_tropical(21:35)   = .true.
   !---------------------------------------------------------------------------------------!
   ...
   is_grass(16)    = .true.
   is_grass(17)    = .false.
   is_grass(18:20)    = .false.
   is_grass(21:35)   = .false. !JL
   !---------------------------------------------------------------------------------------!
   ...
   rho(21:35)     = 0.6 !0.71   ! 0.60 JL
  !rho(21:35)     = 0.40   ! 0.60 JL
   !---------------------------------------------------------------------------------------!

   !----- Specific leaf area [m² leaf / kg C] ---------------------------------------------!
   !----- [KIM] - new tropical parameters. ------------------------------------------------!
   !SLA(1:4)   = 10.0**(2.4-0.46*log10(12.0/leaf_turnover_rate(1:4))) * C2B * 0.1
   SLA(1:4) = 10.0**(1.6923-0.3305*log10(12.0/leaf_turnover_rate(1:4))) !JL
   SLA(5)     = 22.0
   SLA(6)     =  6.0
   SLA(7)     =  9.0
   SLA(8)     = 10.0
   ...
   SLA(17)    = 10.0
   SLA(18:20)   = 10.0**(2.4-0.46*log10(12.0/leaf_turnover_rate(18:20))) * C2B * 0.1
   SLA(21:35) = 19.66 !*1.3 !JL
  ! SLA(30) = SLA(2) !JL
  !print*, 'SLA(1)',SLA(2),SLA(3),SLA(4)
   ...
   horiz_branch(18)     = 0.57
   horiz_branch(19)     = 0.39
   horiz_branch(20)     = 0.61
   horiz_branch(21:35)     =  0.57 !JL
   !---------------------------------------------------------------------------------------!
...
!   q(4)     = 1.0
   ...
   qsw(18:20)    = SLA(18:20)   / sapwood_ratio(18:20)    !new is SLA(1:4)/(3900.0*2.0/1000.0)
   qsw(21:35)    = SLA(21:35)   / sapwood_ratio(21:35)    !new is SLA(1:4)/(3900.0*2.0/1000.0) !JL
   !---------------------------------------------------------------------------------------!
   ...
   !JL changed initial density for PFTs 2:4 and 21:35
   init_density(2)     = 0
   init_density(3)     = 0 
   init_density(4)     = 0 
   init_density(21:35) = 1.380625 !Null Fixer.. PFT 30 is the only one in this simulation and fixation rate = 0 
   init_density(5)     = 0.1
   ...
   b1Ht(18:20)   = 0.37 * log(10.0)
   b1Ht(21:35)   = 0.37 * log(10.0) !JL
      ...
      if (is_tropical(ipft)) then
         ...
         case (0,2:4)
            ...
            aux        = ( (a2l - a1) + b1Ht(ipft) * (c2l - c1l) + log(rho(ipft))          &
                         * (d2l - d1l)) * (1.0/log(dcrit))  !*3  !JL
            b2Bl(ipft) = C2B * b2l + c2l * b2Ht(ipft) + aux
         case (1)
        ! JL! b1Bl increase leaf biomass and leaf area :wood ratio...
        ! JL! SLA increases leaf area ( m2 leaf/kg C).. leaf becomes thinner.. more photosynthesis per leaf C
   ...
   b1Bs_small(16)    = 0.0 
   b1Bs_small(17)    = 0.0
   b1Bs_small(18:20)   = 0.0 
   b1Bs_small(21:35)   = 0.0 !JL
   ...
   b2Bs_small(16)    = 0.0
   b2Bs_small(17)    = 0.0
   b2Bs_small(18:20)   = 0.0
   b2Bs_small(21:35)   = 0.0 !JL
   !---------------------------------------------------------------------------------------!
 ...
 !  print*,b1Bs_small(2),b1Bs_small(30) !DIFFERENT
 !  print*,b2Bs_small(2),b2Bs_small(30)
 !  print*,b1Bs_big(2),b1Bs_big(30) !DIFFERENT
 !  print*,b2Bs_big(2),b2Bs_big(30)
   !---------------------------------------------------------------------------------------!
   ...
   b1Ca(18:20)   = exp(-1.853) * exp(b1Ht(18:20)) ** 1.888
   b1Ca(21:35)   = exp(-1.853) * exp(b1Ht(21:35)) ** 1.888!JL 
   !----- Slope.  -------------------------------------------------------------------------!
   b2Ca(1:4)   = b2Ht(1:4) * 1.888
   b2Ca(5:13)  = 0.8068806
   b2Ca(14:17) = b2Ht(14:17) * 1.888
   b2Ca(18:20)   = b2Ht(18:20) * 1.888
   b2Ca(21:35)   = b2Ht(21:35) * 1.888 !JL
   !---------------------------------------------------------------------------------------!
   ...
   !---------------------------------------------------------------------------------------!
   b1Vol(1:18)  = 0.65 * pi1 * 0.11 * 0.11
   b2Vol(1:18)  = 2.0
   b1Vol(21:35)  = 0.65 * pi1 * 0.11 * 0.11 !JL
   b2Vol(21:35)  = 2.0                      !JL
   select case (iallom)
   case (0:2)
      b1Rd(1)     = - 0.700
      ...
      b1Rd(18:20)   = - exp(0.545 * log(10.))
     b1Rd(21:35)   = - exp(0.545 * log(10.))!JL
   ...
   case (3)
      ...
      !------------------------------------------------------------------------------------!
      b1Rd(1:35)  = -0.2185333 !JL
      b2Rd(1:35)  =  0.5436442 !JL
   case (4)
      !------------------------------------------------------------------------------------!
      ...
      !------------------------------------------------------------------------------------!
      b1Rd(1:35)  = -1.1140580 !JL
      b2Rd(1:35)  =  0.4223014 !JL
   end select
   !---------------------------------------------------------------------------------------!
   ...
   rdiamet(17)    = 2.04
   rdiamet(18:20)   = 1.86
   rdiamet(21:35)   = 1.86!JL
   !----- Length ratio. Järvelä used rdiamet^2/3, so do we... -----------------------------!
   rlength(1:35)  = rdiamet(1:35)**twothirds
   ...
   conijn_a(18:20)   = 0.96305883
   conijn_a(21:35)   = 0.96305883!JL
   ...
   conijn_b(18:20)   = -0.7178682
   conijn_b(21:35)   = -0.7178682 !JL
   ...
   conijn_c(18:20)   = 0.00490734
   conijn_c(21:35)   = 0.00490734!JL
   ...
   conijn_d(18:20)   = -0.0456370
   conijn_d(21:35)   = -0.0456370!
   return
...
c2n_slow       = 10.0  ! Carbon to Nitrogen ratio, slow pool.      !JL!
c2n_structural = 150.0 ! Carbon to Nitrogen ratio, structural pool. !JL!
c2n_storage    = 150.0 ! Carbon to Nitrogen ratio, storage pool.     !JL!
c2n_stem       = 150.0 ! Carbon to Nitrogen ratio, structural stem.   !JL!
l2n_stem       = 150.0 ! Carbon to Nitrogen ratio, structural stem.   !JL!

plant_N_supply_scale = 0.5 

c2n_leaf(1:5)    = 1000.0 / ((0.11289 + 0.12947 *   Vm0(1:5)) * SLA(1:5)  ) !JL!
...
subroutine init_pft_leaf_params()
   ...
   clumping_factor(18:20)   = 1.000d0 ! 7.350d-1
   clumping_factor(21:35)   = 1.000d0 ! 7.350d-1

   !---------------------------------------------------------------------------------------!
   !      The following parameters are second sources found in Gu et al. (2007)            !
   !---------------------------------------------------------------------------------------!
   c_grn_leaf_dry(1:35)      = 3218.0    ! Jones 1992  J/(kg K)
   c_ngrn_biom_dry(1:35)     = 1256.0    ! Forest Products Laboratory 
   wat_dry_ratio_grn(1:35)   = 2.5       ! 
   !wat_dry_ratio_grn(1:35)   = 1.5       ! Ceccato et al. 2001
   wat_dry_ratio_ngrn(1:35)  = 0.7       ! Forest Products Laboratory
   !---------------------------------------------------------------------------------------!
   ...
   ! assumption.                                                                           !
   !---------------------------------------------------------------------------------------!
   delta_c(1:35) = 100. * wat_dry_ratio_ngrn(1:35)                                         &
                 * (-0.06191 + 2.36e-4 * t3ple - 1.33e-2 * wat_dry_ratio_ngrn(1:35))
   ...
   b1Cl(12:16) = 0.99
   b1Cl(17)    = 0.3106775
   b1Cl(18:20)   = 0.3106775
   b1Cl(21:35)   = 0.3106775!JL
   !----- Slope. ----------------------------------------------------------------------!
   b2Cl(1)     = 1.0
   b2Cl(2:4)   = 1.098
   b2Cl(5)     = 1.0
...
subroutine init_pft_repro_params()
   ...
   st_fract(17)            = 0.0
   st_fract(18:20)           = 0.0
  st_fract(21:35)           = 0.0 !JL

   seed_rain(1:35)         = 0.0
!   seed_rain(1:4)         = 0.01/12.  ! This adds 0.01 kgC/m2/year.

   nonlocal_dispersal(1:5) = 1.0
!   nonlocal_dispersal(1:2) = 1.0
!   nonlocal_dispersal(3) = 0.325
!   nonlocal_dispersal(4) = 0.074
   ...
   nonlocal_dispersal(18:20) = 1.0
   nonlocal_dispersal(21:35) = 1.0 !JL
   ...
   repro_min_h(16)         = 0.0
   repro_min_h(17)         = 5.0
   repro_min_h(18:20)        = 5.0
   repro_min_h(21:35)        = 5.0 !JL
...
!   min_new_patch_area = 0.5
   min_new_patch_area = 0.005  !0.0005 for disturbance runs JL

   !----- Only trees above this height create a gap when they fall. -----------------------!
   treefall_hite_threshold = 10.0 
!   treefall_hite_threshold = 5.0
...
subroutine init_soil_coms
   ...
   soil = (/                                                                               &
      !----- 1. Sand. ---------------------------------------------------------------------!
       soil_class( -0.121,     0.395,     4.05, 1465000.,  0.026183447        &
                 ,  0.032636,  .18e-3,  0.000500000,   0.3000,       4.8000        &
                 ,      -2.7000,  0.135,        0.229,    0.352,        0.97        &
                 ,        0.030,        0.050,        1200.,    1600.              )       &
      !----- 2. Loamy sand. ---------------------------------------------------------------!
      ,soil_class( -0.090,     0.410,     4.38, 1407000.,  0.041560499        &
                 ,  0.050323046,  .16e-3,  0.000600000,   0.3000,       4.6600        &
                 ,      -2.6000,  0.150,        0.212,    0.335,        0.92        &
                 ,        0.07,        0.115,        1250.,    1600.              )       &
      !----- 3. Sandy loam. ---------------------------------------------------------------!
      ,soil_class( -0.218,     0.435,     4.9, 1344000.,  0.073495043        &
                 ,  0.085973722,  .34e-4,  0.00077000,   0.2900,       4.2700        &
                 ,      -2.3100,  0.195,        0.183,    0.307,        0.80        &
                 ,        0.18,        0.230,        1300.,    1600.              )       &
      !----- 4. Silt loam. ----------------------------------------------------------------!
      ,soil_class( -0.786,     0.485,     5.3, 1273000.,  0.150665475        &
                 ,  0.171711257,  .72e-5,  0.00001100,   0.2700,       3.4700        &
                 ,      -1.7400,  0.255,        0.107,    0.250,        0.57        &
                 ,        0.40,        0.640,        1400.,    1600.              )       &
      !----- 5. Loam. ---------------------------------------------------------------------!
      ,soil_class( -0.478,     0.451,     5.39, 1214000.,  0.125192234        &
                 ,  0.142369513,  .69e-5,  0.002200000,   0.2800,       3.6300        &
                 ,      -1.8500,  0.240,        0.140,    0.268,        0.60        &
                 ,        0.35,        0.420,        1350.,    1600.              )       &
      !----- 6. Sandy clay loam. ----------------------------------------------------------!
      ,soil_class( -0.299,     0.420,     7.12, 1177000.,  0.136417267        &
                 ,  0.150969505,  .63e-5,  0.001500000,   0.2800,       3.7800        &
                 ,      -1.9600,  0.255,        0.163,    0.260,        0.65        &
                 ,        0.31,        0.140,        1350.,    1600.              )       &
      !----- 7. Silty clay loam. ----------------------------------------------------------!
      ,soil_class( -0.356,     0.477,     7.75, 1319000.,  0.228171947        &
                 ,  0.248747504,  .17e-5,  0.00011000,   0.2600,       2.7300        &
                 ,      -1.2000,  0.322,        0.081,    0.195,        0.35        &
                 ,        0.59,        0.560,        1500.,    1600.              )       &
      !----- 8. Clayey loam. --------------------------------------------------------------!
      ,soil_class( -0.630,     0.476,     8.52, 1227000.,  0.192624431        &
                 ,  0.210137962,  .24e-5,  0.002200000,   0.2700,       3.2300        &
                 ,      -1.5600,  0.325,        0.116,    0.216,        0.48        &
                 ,        0.45,        0.340,        1450.,    1600.              )       &
      !----- 9. Sandy clay. ---------------------------------------------------------------!
   ...
   do nsoil = 1, 8
      soil(nsoil)%soilcp = 0.1 - 0.07 * soil(nsoil)%xsand
...
subroutine init_rk4_params()
   ...
   checkbudget = .true.              ! Flag to check CO2, water, and energy budgets every           !JL! 
   !checkbudget = .false.                     !     time step and stop the run in case any of these 
                                     !     budgets don't close.
   !---------------------------------------------------------------------------------------!
   ...
   effarea_transp(18:20)  = 1.d0 ! Hypostomatous
   effarea_transp(21:35)  = 1.d0 ! Hypostomatous !JL
   !---------------------------------------------------------------------------------------!
