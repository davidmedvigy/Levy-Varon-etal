...
module mortality
   ...
   subroutine mortality_rates(cpatch,ipa,ico,avg_daily_temp, patch_age)
    ...
    !  cpatch%mort_rate(1,ico) = mort3(ipft) ! INITIAL CODE
      ...
      if(ipft<30)then
      cpatch%mort_rate(1,ico) = mort3(ipft) * 0.9 !0.9 !JL
      else
      cpatch%mort_rate(1,ico) = mort3(ipft) * 1.1
      endif

!print*, 'Mort pft2',mort3(2) * 0.9, 'Mort pft3', mort3(3) * 0.9, 'Mort pft4', mort3(4) * 0.9, 'Mort pft30', mort3(30) * 1.1
!print*, 'Mort pft2',mort3(2), 'Mort pft3', mort3(3), 'Mort pft4', mort3(4) , 'Mort pft30', mort3(30) 
