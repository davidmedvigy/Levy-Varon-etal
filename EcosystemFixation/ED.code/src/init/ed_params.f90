...
print*, 'Vm0(2:4)', Vm0(2:4),' Vm0(30)', Vm0(30)
...
!   mort1(4)  = 10.0
   ...
   mort3(2)  = 0.15 * (1. - rho(2))  
   mort3(3)  = 0.15 * (1. - rho(3))  
   mort3(4)  = 0.15 * (1. - rho(4))  
...
!   seedling_mortality(4)  = 0.97
   ...
   seedling_mortality(21:35)  = 0.95 !JL 
...
!   q(4)     = 1.0
   ...
   !JL! Changed initial density for Agua Salud simulations
   ! (order of values for init_denisty(2:4 and 30: plot 4,3,2,1,total,ed_initial)  
   init_density(2)     = 0.244875    !0.9795     !0.1735 plot4!0.144 plot3 !0.249  plot2   !0.413 plot1   !0.9795 !0.1  
   init_density(3)     = 0.697625    !2.7905     !0.614 plot4 !0.519 plot3 !1.451   plot2   !0.2065 plot1  !2.7905  !0.1  !JL!
   init_density(4)     = 0.422125     !1.6885     !0.035plot4  !0.1925plot3 !0.0775  plot2   !1.3835  plot1 !1.6885 !0.1  !JL!
   init_density(21:35) = 0.016   !0.064      !0.0185plot4 !0.005 plot3 !0.026   plot2   !0.0145 plot1  !0.064  ! 0.1 !JL
   init_density(5)     = 0.1
...
print*, 'c2n_leaf(2:4)',c2n_leaf(2:4),'c2n_leaf(30)',c2n_leaf(30)
