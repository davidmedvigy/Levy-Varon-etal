...
!==========================================================================================!
   ...
   subroutine filltab_edtype_p11(cgrid,igr,init,var_len,var_len_global,max_ptrs,nvar)
      ...
      if (associated(cgrid%total_NPP) then
         ...
         call metadata_edio(nvar,igr,'total_NPP','[kg C/m2 forest]','ipoly') 
      end if
      ...
      if (associated(cgrid%total_evapotranspiration) then
         ...
         call metadata_edio(nvar,igr,'total_evapotranspiration','[kg H20/m2 forest]','ipoly') 
      end if
     ...
     if (associated(cgrid%annual_evapotranspiration) then
         ...
         call metadata_edio(nvar,igr,'annual_evapotranspiration','[kg C/m2 forest]','ipoly') 
      end if
      ...
      if (associated(cgrid%annual_NPP) then
         ...
         call metadata_edio(nvar,igr,'annual_NPP','[kg C/m2 forest]','ipoly') 
      end if 
