   ...
   polygonloop: do ipy = 1,cgrid%npolygons
      ...
      siteloop: do isi = 1,cpoly%nsites
         ...
         patchloop: do ipa = 1,csite%npatches
            ...
            !------------------------------------------------------------------------------! 
            !CALCULATION 1: Schimel 1996, based on annual evapotranspiration               !
            !------------------------------------------------------------------------------!
            BNF_input_today =0

            !evapotranspiration (kg water/m2/year)  ,  cgrid%annual_evapotranspiration(1)   
            ! Convert evapotranspiraiton to units  used in Schimel 1996 (cm/yr)
            water_density = 1000    !1000kg water/m3 water 
            evapotranspiration_converted= cgrid%annual_evapotranspiration(1)*1/water_density*100 
            ! gives cm/yr

            BNF_input = max(0.0, 0.008* (evapotranspiration_converted - 40))! Fixation UNITSe gN/m2 
            BNF_input_today = BNF_input/30 *0.001 ! kg N/m2 , this assumes monthly timestep

           !------------------------------------------------------------------------------!        

            !------------------------------------------------------------------------------! 
            !Nitrogen deposition.                                                          !
            !Deposition rate is based on 0.0009kg N/m2/yr and will be                      ! 
