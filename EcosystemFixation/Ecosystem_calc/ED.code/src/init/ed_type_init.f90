...
subroutine init_ed_cohort_vars(cpatch,ico, lsl)
  ...
  ! use decomp_coms   , only :FSN_ndays_to_avg                     !JL!
   ...
   cpatch%excess_carbon      (ico) = 0.0 !JL,XXT
   cpatch%nstorage           (ico) = 0.0 !JL
  ...
  ! cpatch%N_limitation_factor(1:FSN_ndays_to_avg,ico)       = 1.0  !JL!
  ! cpatch%N_limitation_factor_bar(ico)                      = 1.0  !JL!
   ...
   if (imoutput > 0 .or. iqoutput > 0) then
     ...
     !cpatch%mmean_nitrogen_uptake  (ico) = 0.0   !JL!
     !cpatch%mmean_N_uptake_pot     (ico) = 0.0   !JL!
...
subroutine init_ed_patch_vars(csite,ip1,ip2,lsl)
   ...
   if (imoutput > 0 .or. iqoutput > 0) then
      ...
      csite%mmean_fsn_in          (ip1:ip2) = 0.0              !JL!
      csite%mmean_ssc_in          (ip1:ip2) = 0.0              !JL!
      csite%mmean_total_plant_nitrogen_uptake  (ip1:ip2) = 0.0 !JL!
   ...
   csite%fsc_in_no_excess              (ip1:ip2) = 0.0 !JL
   csite%N_leached                     (ip1:ip2) = 0.0 !JL
   csite%N_gas_loss                    (ip1:ip2) = 0.0 !JL
   csite%interval_DON_loss             (ip1:ip2) = 0.0 !JL
...
subroutine init_ed_poly_vars(cgrid)
   ...
   do ipy = 1,cgrid%npolygons
      ...
      cpoly%daily_pcpg(1)       = 0.0    !JL
      cpoly%daily_evap(1)       = 0.0    !JL
      cpoly%daily_transp(1)     = 0.0    !JL
      cgrid%ForestN(1)          = 0.0    !JL
      cgrid%PlantN(1)           = 0.0    !JL
      cgrid%SoilN(1)            = 0.0    !JL
      cgrid%total_N_Fixation(1) = 0.0    !JL
      cgrid%total_DON_loss(1)   = 0.0    !JL
      cgrid%total_DIN_loss(1)   = 0.0    !JL
      cgrid%total_Ngas_loss(1)  = 0.0     !JL
      cgrid%total_N_demand(1)   = 0.0    !JL
      cgrid%total_N_supply(1)  = 0.0     !JL
      cgrid%total_evapotranspiration(1)  = 0.0     !JL
      cgrid%annual_evapotranspiration(1) = 0.0     !JL
