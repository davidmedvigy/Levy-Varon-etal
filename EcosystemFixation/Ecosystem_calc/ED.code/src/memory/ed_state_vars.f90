...
!============================================================================!
  ...
  type polygontype
     ...
     real, pointer,dimension(:)  :: total_N_supply  ! [sum of N supply for all trees]      
     real, pointer,dimension(:)  :: total_N_demand  ! [sum N_uptake_pot for all trees] 
...
!============================================================================!
  ...
  type edtype
     ...
     real,pointer,dimension(:) :: total_N_demand       !JL
     real,pointer,dimension(:) :: total_N_supply       !JL
...
!! NOT USED       allocate(cgrid%tau(npolygons))
       ...
       allocate(cgrid%total_N_demand   (npolygons))!JL
       allocate(cgrid%total_N_supply   (npolygons))!JL
...
!============================================================================!
  subroutine allocate_polygontype(cpoly,nsites)
    ...
    allocate(cpoly%total_N_supply          (nsites))!JL!
    allocate(cpoly%total_N_demand          (nsites))!JL!
...
!============================================================================!
  subroutine nullify_edtype(cgrid)
    ...
    type(edtype),target :: cgrid
       ...
       nullify(cgrid%total_N_demand    ) !JL
       nullify(cgrid%total_N_supply    ) !JL
...
!============================================================================!
  subroutine nullify_polygontype(cpoly)
    ...
    nullify(cpoly%total_N_supply   )!JL!
    nullify(cpoly%total_N_demand   )!JL!
...
!============================================================================!
  ...
  ! ===================================================
    ...
    type(edtype),target :: cgrid
       ...
       if(associated(cgrid%total_N_supply          )) deallocate(cgrid%total_N_supply      )!JL
       if(associated(cgrid%total_N_demand          )) deallocate(cgrid%total_N_demand      )!JL
...
!JL!
     ...
     if (associated(cgrid%total_evapotranspiration)) then
         nvar=nvar+1
         call vtable_edio_r(npts,cgrid%total_evapotranspiration,nvar,igr,init,cgrid%pyglob_id, &
              var_len,var_len_global,max_ptrs,'total_evapotranspiration :11:hist:anal:opti:dail:year:mont') 
         call metadata_edio(nvar,igr,'total_evapotranspiration','[kg N/m2 forest]','ipoly') 
      end if
