Figure3.R contains the R code used to create figure 3. Figure 3 shows results from the Individual level fixation, No Fixation, Fixer,Null Fixer simulations.  
