...
n1=0.;n2=0.;nup=0.;nloss=0.
            ...
            cohortloop: do ico = 1,cpatch%ncohorts
              ...
              ! adjusting carbon allocated in growth equations below
              ! based on nitrogen limitation.         
              if (n_plant_lim .NE. 0 )then
               ...
               !---------------------------------------------------------------------------!
               !  Take the nitrogen from Nstorage  before taking it out of the soil for    !
               !  structural growth.  net_stem_N_uptake = N taken out of soil              !                                  
               !---------------------------------------------------------------------------!

               ! Storage satisfies N demand   
               if (cpatch%nstorage(ico) >=   net_stem_N_uptake/cpatch%nplant(ico) ) then
                  ...
                  net_stem_N_uptake = 0
               ! Storage does not satisfies N demand plant must take N out of soil   
               ...
               !---------------------------------------------------------------------------!
               !  Determine how much nitrogen is needed for seed reproduction to seeds.    !
               !---------------------------------------------------------------------------!
               ...
               ! N_for_seeds = N taken out of soil                                         !
               !---------------------------------------------------------------------------!
               ! Storage satisfies N demand 
               ...
               !  This is necessary because c2n_recruit does not have to                   !
               !---------------------------------------------------------------------------!
