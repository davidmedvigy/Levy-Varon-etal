...
module nutrient_constants
  ...
  real, parameter :: leaching_efficiency_factor = 0 !0.05  !fraction of N that can be lost by leaching from mineralized_soil_N 
  real, parameter :: DON_loss    = 0 !0.0001/365           !Dissolved Organic N loss, about 1/5 of the total N deposition
  ...
  real, parameter :: gas_loss_rate = 0 !0.2                ! Gas loss is approximately 20% of total N loss if the site has
